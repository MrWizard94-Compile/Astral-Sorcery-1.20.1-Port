...
/**
 * String constants for all built-in perk attribute names.
 *
 * <p>These are the translation/lookup keys used in NBT serialization and
 * tooltip display. Naming convention: {@code perk.astralsorcery.<category>.<type>}.</p>
 *
 * <p>INC_ variants are incremental (multiplicative, % based).
 * ADD_ variants are additive (flat value added to base).</p>
 */
public final class PerkNamesAS {

    private PerkNamesAS() {}

    // ---- Incremental (percentage) variants ----
    ...
    /** Constructs the full perk name key from the namespaced path. */
