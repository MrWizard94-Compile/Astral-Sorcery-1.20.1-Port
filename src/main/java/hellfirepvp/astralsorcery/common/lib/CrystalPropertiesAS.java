...
public class CrystalPropertiesAS {
    ...
    public static class Properties {
        ...
        @Nonnull public static CrystalProperty PROPERTY_SIZE;
        @Nonnull public static CrystalProperty PROPERTY_PURITY;
        @Nonnull public static CrystalProperty PROPERTY_SHAPE;

        @Nonnull public static CrystalProperty PROPERTY_TOOL_DURABILITY;
        @Nonnull public static CrystalProperty PROPERTY_TOOL_EFFICIENCY;

        @Nonnull public static CrystalProperty PROPERTY_RITUAL_RANGE;
        @Nonnull public static CrystalProperty PROPERTY_RITUAL_EFFECT;
        @Nonnull public static CrystalProperty PROPERTY_COLLECTOR_COLLECTION_RATE;

        @Nonnull public static CrystalProperty PROPERTY_CST_DISCIDIA;
        @Nonnull public static CrystalProperty PROPERTY_CST_ARMARA;
        @Nonnull public static CrystalProperty PROPERTY_CST_AEVITAS;
        @Nonnull public static CrystalProperty PROPERTY_CST_VICIO;
        @Nonnull public static CrystalProperty PROPERTY_CST_EVORSIO;
        @Nonnull public static CrystalProperty PROPERTY_CST_MINERALIS;
        @Nonnull public static CrystalProperty PROPERTY_CST_LUCERNA;
        @Nonnull public static CrystalProperty PROPERTY_CST_BOOTES;
        @Nonnull public static CrystalProperty PROPERTY_CST_OCTANS;
        @Nonnull public static CrystalProperty PROPERTY_CST_HOROLOGIUM;
        @Nonnull public static CrystalProperty PROPERTY_CST_FORNAX;
        @Nonnull public static CrystalProperty PROPERTY_CST_PELOTRIO;
    }
    ...
    public static class Usages {
        ...
        @Nonnull public static PropertyUsage USE_RITUAL_EFFECT;
        @Nonnull public static PropertyUsage USE_RITUAL_RANGE;
        @Nonnull public static PropertyUsage USE_COLLECTOR_CRYSTAL;
        @Nonnull public static PropertyUsage USE_LENS_TRANSFER;
        @Nonnull public static PropertyUsage USE_LENS_EFFECT;
        @Nonnull public static PropertyUsage USE_TOOL_DURABILITY;
        @Nonnull public static PropertyUsage USE_TOOL_EFFECTIVENESS;
    }
